...
app.providerMyProfileView = kendo.observable({
...
(function(parent) {
    ...
    var providerMyProfileViewModel = kendo.observable({
    ...
    parent.set('providerMyProfileViewModel', providerMyProfileViewModel);

})(app.providerMyProfileView);